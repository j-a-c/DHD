...
IMPORTANT! This version of the script uses the smart DHD method.
This version also outputs a different penalty graph.
...
while trialCounter <= trials:
    ...
    while counter <= itersPerTrial:
        ...
        call(['java', '-cp', 'DHD.jar', 'DHD.SmartPartialSolver', '-i',
